...
def generate_gradcam(model, image_tensor, target_class=None, method="gradcam++", device='cuda'):
    """
...
def multi_method_comparison(model, image_tensor, pred_class, device='cuda', save_path=None):
    """
